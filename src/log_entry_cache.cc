...
void LogEntryCache::Append(eraftkv::Entry* e) {
     ...
     * Returns: The number of bytes required to serialize this message. Return type:.
     *
     */
    ent_count_ += 1;
...
/**
 * @brief erase log entry with id < idx, idx is the first log of the remaining log structure
 * 
 * @param idx 
 * @return int64_t 
 */
