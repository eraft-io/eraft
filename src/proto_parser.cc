...
ParseResult ProtoParser::_ParseStrlist(const char*& ptr, const char* end, std::vector<std::string>& results)
{
...
ParseResult ProtoParser::_ParseStrval(const char*& ptr, const char* end, std::string& result)
{
    assert (paramLen_ >= 0);
