...
ParseResult ProtoParser::_ParseMulti(const char*& ptr,
                                     const char*  end,
                                     int&         result) {
  if (end - ptr < 3)
    return ParseResult::wait;
...
ParseResult ProtoParser::_ParseStrlist(const char*&              ptr,
                                       const char*               end,
...
ParseResult ProtoParser::_ParseStr(const char*& ptr,
                                   const char*  end,
                                   std::string& result) {
  if (paramLen_ == -1) {
...
ParseResult ProtoParser::_ParseStrval(const char*& ptr,
                                      const char*  end,
                                      std::string& result) {
  assert(paramLen_ >= 0);
...
ParseResult ProtoParser::_ParseStrlen(const char*& ptr,
                                      const char*  end,
                                      int&         result) {
  if (end - ptr < 3)
    return ParseResult::wait;
