...
const (
	KVService_Command_FullMethodName   = "/kvraftpb.KVService/Command"
	KVService_GetStatus_FullMethodName = "/kvraftpb.KVService/GetStatus"
)
...
func (c *kVServiceClient) Command(ctx context.Context, in *CommandRequest, opts ...grpc.CallOption) (*CommandResponse, error) {
	...
	err := c.cc.Invoke(ctx, KVService_Command_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KVService_Command_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KVService_Command_FullMethodName,
	}
