...
var rmServerGroupCmd = &cobra.Command{
	Use:   "rm_server_group [metaserver addrs] [gid]",
	Short: "remove block server group from cluster",
	Long:  ``,
	Run: func(cmd *cobra.Command, args []string) {
		...
		req := &pb.ServerGroupMetaConfigRequest{
			Gids:   []int64{int64(gid)},
			OpType: pb.ConfigServerGroupMetaOpType_OP_SERVER_GROUP_LEAVE,
		}
...
func init() {
	rootCmd.AddCommand(rmServerGroupCmd)
}
